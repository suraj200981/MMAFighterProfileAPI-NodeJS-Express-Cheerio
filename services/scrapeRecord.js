...
async function findAllFighterProfiles(client) {
  return new Promise((resolve, reject) => {
    ...
    //find all records in mongo db asynchonously
    ...
    //the above collection.find() is getting skipped. rewrite code so that it works
  });
}

async function start(client) {
  await findAllFighterProfiles(client, (result) => {
    console.log(result);
